...
Para ilustrar de manera más intuitiva el efecto del filtro de Kalman sobre el movimiento, se generó una trayectoria diagonal del usuario dentro del entorno de prueba. La Figura~\ref{fig:trajectory_diagonal} muestra en el mismo plano la posición estimada con y sin filtrado, permitiendo observar claramente cómo el filtro suaviza los desplazamientos y reduce los saltos erráticos presentes en los datos crudos.
