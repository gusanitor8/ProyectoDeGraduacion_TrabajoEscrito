...
El resultado se validó mediante la comparación visual entre la magnitud del vector de posición filtrado y no filtrado a lo largo del tiempo. Mientras la señal original mostraba un patrón ruidoso con picos abruptos (Figura~\ref{fig:jitter}), la señal filtrada exhibía una forma sinusoidal limpia y continua (Figura~\ref{fig:kalman}), reflejando el movimiento diagonal esperado.
